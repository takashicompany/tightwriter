...
|部品|個数|備考|
|:--|:--|:--|
|PCB|1||ガーバデータは[こちら](https://github.com/takashicompany/tightwriter/tree/master/gerber)です。|
...
|[ウレタンクッション](https://shop.yushakobo.jp/products/a0800ur-01-6)|6|底面の滑り止めに使用するため、100円均一ショップなどで代用可能です。|
...
|[コンスルー](https://shop.yushakobo.jp/products/31?_pos=1)|2|無くても組み立ては可能ですが、難易度がかなり高くなります。また失敗をしたときのリカバリーに膨大な手間がかかります。自作キーボードの組み立てに慣れた方以外は、コンスルーを使用することを強く推奨します。|
|[キースイッチソケット](https://shop.yushakobo.jp/products/a01ps)|35|無くても組み立ては可能です。取り付けるとキースイッチを交換しやすくなるのと、組み立ての失敗を防ぎやすくなります。|


### オプション
|部品|個数|備考|
|:--|:--|:--|
|[LED(WS2812B)](https://shop.yushakobo.jp/products/a0800ws-01-10)|10|アンダーグロウライトとしてキーボードの底面を光らせることができます。|
...
Twitterのハッシュタグは [`#Tightwriter #自作キーボード`](https://twitter.com/search?q=%23%E8%87%AA%E4%BD%9C%E3%82%AD%E3%83%BC%E3%83%9C%E3%83%BC%E3%83%89%20%23Tightwriter&src=typed_query) を付けていただけると幸いです。
